...
\jf{de- 否定、加强语气，``掷地有声''即 declaim}
\c{biography} \yb{baI"6gr@fi} \n 传记；档案；传记体文学；个人简介
\jf{bio- 生命，-graph 写，记录生命即传记}
\cc{geography} \yb{dZi"6gr@fi} \n 地理（学）；地形，地势；布局
\jf{geo- 土地，-graph- 写，写一些土地的东西即地理学，geo- 来自希腊神话 Gaea 地母盖亚}
...
\jf{-astro = -aster 星星，即 star 字母的重组，AstroBoy 阿童木}
...
\jf{ob- 加强、否定，这里是否定，-scure 看成 sky，``不好的天空'' 即阴暗、模糊、晦涩的}
...
\jf{cat- 向下，-log- 说，如 -ology- 学说中有个 -log- 说，接着往下说即目录}
\jf{log- = loc- = loq- 说}
...
\jf{pan- = ban- = man- = fan- 手，其中 pan- 也表示全部，fac- = fec- = fic- 做}
...
\jf{sol- 太阳，来自意大利语，如 solar；独自，来自 solo}
...
\jf{sol- 单独，-cit 看作 city，一个人在城市奋斗难免要求人}
...
\jf{dis- 不同，-crim- 犯罪，同样的罪行有不同的对待即歧视，常见阅读与翻译}
...
\jf{tag- = teg- = tan- = tam- 接触，来自 tangent 切线}
...
\jf{in- 内，-teg- 接触，内部接触上即合并，如两块光洁金属长时间接触会因分子热运动而结合在一起}
...
\jf{con- 一起，-templ- 按 temple 寺庙来记忆}
...
\jf{-cess 走，如 excess、exceed、process、proceed}
...
\jf{inter- 相互，-sect 切，来自 section，两条线相互切}
\c{insect} \yb{"Insekt} \n 虫，昆虫；卑鄙的人；微贱的人，小人 \a 昆虫的；卑劣的
\jf{-sect 一截一截的，昆虫即节肢动物}
\c{interject} \yb{""Int@"dZekt} \vt （突然）插入，插话；打断
\jf{inter- 相互，-ject 扔，我向你抛出一句话、你向我抛出一句话}
